...
save([path,name11],'result','direction');
...
save([path,name12],'result','direction');
...
save([path,name19],'result','direction');
...
save([path,name20],'result','direction');
...
result = [1*60+38,3*60+58,6*60+5,8*60+43,10*60+29,12*60+46,14*60+7,15*60+50,17*60+42,19*60+13,19*60+52,21*60+2,22*60+55,...
    25*60+9,26*60+51, ];
direction = [1,0,1,0,0,1,0,1,0,1];
save([path,name25],'result','direction');
